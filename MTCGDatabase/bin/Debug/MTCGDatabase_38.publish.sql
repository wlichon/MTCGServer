...
GO
PRINT N'The following operation was generated from a refactoring log file 8af49ca1-91ee-4087-b08f-d030e8efe127';

PRINT N'Rename [dbo].[MTCGCard].[Index] to CardNumber';


GO
EXECUTE sp_rename @objname = N'[dbo].[MTCGCard].[Index]', @newname = N'CardNumber', @objtype = N'COLUMN';
